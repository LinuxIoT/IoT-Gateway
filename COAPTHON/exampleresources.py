...
sys.path.insert(0, '/home/ahmer/Ahmer/Techknox/Python_Exercises/IoT-Gateway-Embedded-V3/')
...
class BasicResource(Resource):
    ...
    """ Weqaar janjua & Ahmer malik, Copyrights (C) Linux IoT"""
    ...
    def render_PUT(self, request):
        ...
        self.queue.get_lock()
        self.queue.put(payl)
        print ("Write Data to Queue by COAP = ")        
